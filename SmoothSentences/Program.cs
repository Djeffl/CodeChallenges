...
var i = IsSmooth("She eats super righteously");
var iw = IsSmooth("Marta appreciated deep perpendicular right trapezoids");
Console.WriteLine();
static bool IsSmooth(string sentence)
{
    return sentence
        .Split(" ").Take(Range.StartAt(1)).Select(word => word.First())
        .Zip(sentence
                .Split(" ")
